...
/**
 *=ENTITY CLASS "TimesheetV2"
 * - данные об отработанному сотрудником времени за весь месяц по дням (31 день);
 * - Класс для создания статических/запеченных данных в Объектах;
 *
 */
@Data
@Entity
//@Table(name="TIMEDATAV2")
@Table(name="TIMESHEET")
public class TimesheetV2 {
    @Id
    ...
    //--(fixed): field "userId" is not exposed at JSON-response when ManyToOne relation used
    ...
    //--15 days (sub)total by hours and type
    @Column(name="T15H")
    private String t15h;
    @Column(name="T15P")
    private String t15p;

    //--31 days total by hours and type
    @Column(name="T31H")
    private String t31h;
    @Column(name="T31P")
    private String t31p;
